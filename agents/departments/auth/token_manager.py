...
from agents.prompts import AUTH_TOKEN_MANAGER
...
class TokenManager:
    name = "auth.token_manager"
    role = "worker"

    SYSTEM_PROMPT = AUTH_TOKEN_MANAGER
    ...
    async def run(self, state: AgentState) -> AgentState:
        ...
        logger.info("token_manager produced implementation, revision=%d", revisions)
