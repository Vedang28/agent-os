...
from agents.prompts import TESTING_STRATEGIST
from core.state import AgentState
from infra.telemetry import get_logger

logger = get_logger("testing.strategist")
...
class TestStrategist:
    ...
    SYSTEM_PROMPT = TESTING_STRATEGIST
    ...
    async def run(self, state: AgentState) -> AgentState:
        ...
        if self._obsidian:
            ...
            for pb in get_playbooks("testing", self._obsidian):
        ...
        logger.info("strategist produced draft for request=%r", request[:80])
