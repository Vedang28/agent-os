...
from agents.prompts import DEVOPS_ARCHITECT

logger = get_logger("devops.architect")
...
class CiCdArchitect:
    ...
    SYSTEM_PROMPT = DEVOPS_ARCHITECT
    ...
    async def run(self, state: AgentState) -> AgentState:
        ...
        if self._obsidian:
            ...
            for pb in get_playbooks("devops", self._obsidian):
